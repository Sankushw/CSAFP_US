...
public class GenericWrappers_US_BD
{
	...
	public String supplierLogin(String pwd, String username, String url) throws InterruptedException
	{
		...
		System.out.println("Supplier login URL===>"+url);
	    dr.get(url);
		dr.manage().window().maximize();
		clickByXpath( "//button[contains(text(),'Log in')]");
		//clickByXpath( ".//button[@id='continue-button']");
	 ...
	 public void screenshot() 
	{
			...
			File destFile = new File(System.getProperty("user.dir")+"/Screenshots/JP/snap"+i+".png");
			try {
